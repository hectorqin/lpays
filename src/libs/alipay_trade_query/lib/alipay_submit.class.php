...
if (!function_exists('createLinkstring')) require_once($self_dir."alipay_core.function.php");
if (!function_exists('md5Sign')) require_once($self_dir."alipay_md5.function.php");
