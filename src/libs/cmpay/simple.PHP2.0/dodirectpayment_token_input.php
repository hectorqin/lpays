<html>
	<head>
		<title>即时到账(双向确认)：DODIRECTPAYMENT</title>
		<link href="css/sdk.css" rel="stylesheet" type="text/css" />
		<meta http-equiv="Content-Type" content="text/html; charset=gb2312">
	</head>

	<body>
      <form name="form1" method="post" action="dodirectpayment_token.php">
         <br>
         <center>
            <input type="hidden" name="merCert" value="">
            <font size=2 color=black face=Verdana><b>即时到账(双向确认)：DODIRECTPAYMENT</b>
            </font>
            <br>
            <br>
            <table class="api">
               ...
               <tr>
                  ...
                  <td>
                     <select name="bankAbbr">
                        ...
                        <option name="SDB"   value="SDB"  >深圳发展银行</option>
                        <option name="GDB"   value="GDB"  >广东发展银行</option>
                        <option name="CITIC" value="CITIC">中信银行</option>
                        <option name="HXB"   value="HXB"  >华夏银行</option>
                        <option name="FIB"   value="FIB"  >兴业银行</option>
                        <option name="CPSRB" value="CPSRB">中国邮政储蓄</option>
                     </select>
                  </td>
               </tr>
               <tr>
