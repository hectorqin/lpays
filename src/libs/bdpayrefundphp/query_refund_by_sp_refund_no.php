 ...
 */
/**
 * 这个是调用bdpay_sdk里通过百度钱包退款流水号查询退款信息的DEMO
 *
 */
 error_reporting(0);
...
$sp_refund_no = $_POST['sp_refund_no_f'];
...
$content = $bdpay_sdk->query_baifubao_refund_result_by_sprefund_no($order_no,$sp_refund_no);
