...
// 签名证书路径
define('SDK_SIGN_CERT_PATH',$DIR.'certs/acp_test_sign.pfx');
...
// 密码加密证书（这条一般用不到的请随便配）
define('SDK_ENCRYPT_CERT_PATH',$DIR.'certs/acp_test_enc.cer');
// const SDK_ENCRYPT_CERT_PATH = '';

// 验签证书路径（请配到文件夹，不要配到具体文件）
define('SDK_VERIFY_CERT_DIR',$DIR.'certs/');
...
// const SDK_FILE_DOWN_PATH = $DIR.'file/';

//日志 目录
define('SDK_LOG_FILE_PATH',$DIR.'logs/');
// const SDK_LOG_FILE_PATH = $DIR.'logs/';
