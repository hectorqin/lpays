...
require_once($self_dir."alipay_core.function.php");
require_once($self_dir."alipay_rsa.function.php");
require_once($self_dir."alipay_md5.function.php");
...
class AlipaySubmit {
	...
	function buildRequestUrl($para_temp) {
		//待请求参数数组
		$para = $this->buildRequestPara($para_temp);
		$base_url=$this->alipay_gateway_new."_input_charset=".trim(strtolower($this->alipay_config['input_charset']));
		return $base_url."&".http_build_query($para);
	}
