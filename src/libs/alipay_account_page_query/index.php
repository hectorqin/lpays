...
<body text=#000000 bgColor=#ffffff leftMargin=0 topMargin=4>
	<div id="main">
		<div id="head">
            ...
            <span class="title">支付宝账务明细分页查询接口快速通道</span>
		</div>
            ...
            <div id="body" style="clear:left">
                <dl class="content">
                    ...
                    <dd>
                        ...
                        <input size="30" name="WIDpage_no" />
                        <span>必填，必须是正整数</span>
                    </dd>
                    <dt>账务查询开始时间：</dt>
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="WIDgmt_start_time" />
                        <span>格式为：yyyy-MM-dd HH:mm:ss</span>
                    </dd>
                    <dt>账务查询结束时间：</dt>
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="WIDgmt_end_time" />
