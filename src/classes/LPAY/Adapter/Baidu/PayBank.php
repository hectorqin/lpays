...
class PayBank extends PayAdapter implements PayAdapterNotify,PayAdapterCallback,Query{
	/**
	 * @var PayConfig
	 */
	protected $_config;
	...
	public function match($name){
		if (in_array($name, $this->support_name())) return true;
	}
	/**
	 * {@inheritDoc}
	 */
	public function pay_render(PayParam $pay_param){
		require_once Utils::lib_path("bdpaybankphp/bdpay_sdk.php");
		require_once Utils::lib_path("bdpaybankphp/bdpay_pay.cfg.php");
		$bank=$this->_name;
