...
class PayConfig extends Config{
	...
	protected $_disable_pay_channels;
	...
	public function set_disable_pay_channels($disable_pay_channels){
		$this->_disable_pay_channels=$disable_pay_channels;
		return $this;
	}
	public function get_disable_pay_channels(){
		//pcredit,moneyFund,debitCardExpress
		return $this->_disable_pay_channels;
	}
}